...
CREATE TABLE aibaduk.CM_FILE (
	CHNL_ID VARCHAR(20) NOT NULL COMMENT '채널ID',
	TARGET_ID VARCHAR(8) NOT NULL COMMENT '타겟ID',
	TARGET_GUBUN VARCHAR(2) NOT NULL COMMENT '타겟구분',
	...
	PRIMARY KEY (CHNL_ID, TARGET_ID, TARGET_GUBUN, FILE_ID)
) COMMENT '공통파일'
ENGINE=InnoDB DEFAULT CHARSET=utf8;
;
...
CREATE TABLE aibaduk.CM_MENU (
	...
	AUDIT_ID VARCHAR(50) NOT NULL COMMENT '최종변경자',
	AUDIT_DTM DATETIME NOT NULL COMMENT '최종변경일시',
	UP_MENU_ID VARCHAR(20) NOT NULL COMMENT '상위메뉴ID',
	MENU_DEPTH SMALLINT(4) COMMENT '메뉴단계',
	MENU_NM VARCHAR(100) COMMENT '메뉴명',
	MENU_URL VARCHAR(100) COMMENT '메뉴경로',
	VISIBLE_YN VARCHAR(100) COMMENT '활성화여부',
	SORT_SEQ VARCHAR(500) COMMENT '정렬순서',
	ETC VARCHAR(500) COMMENT '메모',
	PRIMARY KEY (MENU_ID)
) COMMENT '메뉴관리'
ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO CM_CODE(L_CD, M_CD, FST_CRER_ID, FST_CRE_DTM, AUDIT_ID, AUDIT_DTM, CODE_NM, SORT_SEQ, REF1, REF2, REF3, ETC)VALUES('MS001', '02', 'MIG', NOW(), 'MIG', NOW(), '저장', '2', 'btn-role-s', '', '', '');
